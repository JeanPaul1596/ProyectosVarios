...
namespace ProyectoFinal
{
    public class InventariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Producto,Cantidad")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Producto,Cantidad")] Inventario inventario)
        {
            if (id != inventario.Id)
            {
                return NotFound();
